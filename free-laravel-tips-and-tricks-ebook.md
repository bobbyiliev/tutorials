...
The web page was built using [Tails](http://devdojo.com/tails?ref=bobbyiliev), a new `kick-ass` drag-and-drop TailwindCSS page builder!
...
You can follow the tips from the book with this online playground here:
...
If you are contributing 🍿 please read the [contributing file](https://github.com/bobbyiliev/laravel-tips-and-tricks-ebook/blob/main/CONTRIBUTING.md) before submitting your pull requests.
